...
?>
<section class="fw-main-row <?php echo esc_attr($section_extra_classes) ?><?php echo do_shortcode( $atts['class_section'] ); ?>" <?php echo $section_style; ?> <?php echo $bg_video_data_attr; ?>>
